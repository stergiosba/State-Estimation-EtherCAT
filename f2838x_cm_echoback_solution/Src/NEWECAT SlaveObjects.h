...
{ DEFTYPE_UNSIGNED8 , 0x8 , ACCESS_READ },
{ DEFTYPE_REAL32 , 0x20 , ACCESS_READ | OBJACCESS_TXPDOMAPPING }, /* Subindex1 - Switch1 */
{ DEFTYPE_REAL32 , 0x20 , ACCESS_READ | OBJACCESS_TXPDOMAPPING }, /* Subindex2 - Switch2 */
{ DEFTYPE_REAL32 , 0x20 , ACCESS_READ | OBJACCESS_TXPDOMAPPING }, /* Subindex3 - Switch3 */
{ DEFTYPE_REAL32 , 0x20 , ACCESS_READ | OBJACCESS_TXPDOMAPPING }}; /* Subindex4 - Switch4 */
...
typedef struct OBJ_STRUCT_PACKED_START {
UINT16 u16SubIndex0;
REAL32 Switch1; /* Subindex1 - Switch1 */
REAL32 Switch2; /* Subindex2 - Switch2 */
REAL32 Switch3; /* Subindex3 - Switch3 */
REAL32 Switch4; /* Subindex4 - Switch4 */
} OBJ_STRUCT_PACKED_END
TOBJ6000;
#endif //#ifndef _NEWECAT_SLAVE_OBJECTS_H_
...
{ DEFTYPE_UNSIGNED8 , 0x8 , ACCESS_READ },
{ DEFTYPE_REAL32 , 0x20 , ACCESS_READ | OBJACCESS_RXPDOMAPPING }, /* Subindex1 - LED1 */
{ DEFTYPE_REAL32 , 0x20 , ACCESS_READ | OBJACCESS_RXPDOMAPPING }, /* Subindex2 - LED2 */
{ DEFTYPE_REAL32 , 0x20 , ACCESS_READ | OBJACCESS_RXPDOMAPPING }, /* Subindex3 - LED3 */
{ DEFTYPE_REAL32 , 0x20 , ACCESS_READ | OBJACCESS_RXPDOMAPPING }}; /* Subindex4 - LED4 */
...
typedef struct OBJ_STRUCT_PACKED_START {
UINT16 u16SubIndex0;
REAL32 LED1; /* Subindex1 - LED1 */
REAL32 LED2; /* Subindex2 - LED2 */
REAL32 LED3; /* Subindex3 - LED3 */
REAL32 LED4; /* Subindex4 - LED4 */
} OBJ_STRUCT_PACKED_END
TOBJ7000;
#endif //#ifndef _NEWECAT_SLAVE_OBJECTS_H_
