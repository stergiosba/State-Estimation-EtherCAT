...
void SPI_init()
{
    ...
    /*Configure SPI Base A with the following:
    *SPIA_BASE: Select SPI A base
    *DEVICE_LSPCLK_FREQ: Low speed peripheral clock of 50 MHz.
    *SPI_PROT_POL1PHA0: SPI Mode 2.
    *SPI_MODE_MASTER: MCU is the master.
    */
