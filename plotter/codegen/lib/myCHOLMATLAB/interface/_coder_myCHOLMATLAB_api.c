/*
 * File: _coder_myCHOLMATLAB_api.c
 *
 ...
 * Return Type  : void
 */
void myCHOLMATLAB_api(const mxArray * const prhs[1], int32_T nlhs, const mxArray
                      *plhs[2])
{
  ...
  L_data = (real_T (*)[25])mxMalloc(sizeof(real_T [25]));
  invL_data = (real_T (*)[25])mxMalloc(sizeof(real_T [25]));
...
void myCHOLMATLAB_atexit(void)
{
  ...
  myCHOLMATLAB_xil_terminate();
  myCHOLMATLAB_xil_shutdown();
...
/*
 * File trailer for _coder_myCHOLMATLAB_api.c
 *
 * [EOF]
 */
